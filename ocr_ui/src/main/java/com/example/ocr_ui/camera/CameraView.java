...
//    }
    ...
    public void takePicture(final File file, final OnTakePictureCallback callback, String contentType) {
        cameraViewTakePictureCallback.file = file;
        cameraViewTakePictureCallback.callback = callback;
        cameraViewTakePictureCallback.type = contentType;
        cameraControl.takePicture(cameraViewTakePictureCallback);
    }
...
//        }
    ...
    private Bitmap crop(File outputFile, byte[] data, int rotation, String type) {
        Log.e("拍摄后的照片", "crop: " + outputFile.getAbsolutePath() + " , " + data + " , " + rotation);
        //  E/拍摄后的照片: crop: /data/user/0/com.jxaic.wsdj/files/idCard/front/pic.jpg , [B@3b36f2a , 90
        try {
            Rect previewFrame = cameraControl.getPreviewFrame();
...
//                }
                // 创建裁剪的cropFile文件
                File outputFile1 = FileUtils.getCropFile(getContext(), type);
